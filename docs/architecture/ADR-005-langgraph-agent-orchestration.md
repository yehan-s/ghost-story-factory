...
> **⚠️ 文档状态**: 本 ADR 为草案，待 ADR-006 (Response LLMClient 迁移) 稳定运行后再正式提交。
> **前置条件**: ADR-004 M1-M4 完成 + ADR-006 生产验证通过 + 至少 3 个完整故事稳定运行 1-2 周。

- 状态: Draft (blocked by ADR-006 stabilization)
- 日期: 2025-11-20
