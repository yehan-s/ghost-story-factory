...
STORY_META = {
    ...
    "npcs": {
        ...
        "lake_red_dress_13": {
            ...
            "death_year": 1987,
            "initial_location": "S2",
            "related_foreshadows": ["1987_red_dress_truth"],
            "key_items": [],
    ...
    "timeline": [
        {"year": 1924, "date": "1924-09-25", "event": "雷峰塔倒。砖中钻出白虫,民间称『白蛇骨』",
         "related_foreshadows": [], "tags": ["塔砖辟邪"]},
        {"year": 1929, "event": "断桥残雪重修。捐资人名单中的『林』被人故意凿掉",
         "related_foreshadows": [], "tags": ["林某"]},
        {"year": 1959, "event": "留下小学 203 琴房,叶某外婆自缢。档案 1959-043",
         "related_foreshadows": ["1991_grandma_link"], "tags": ["留下小学", "203 琴房"]},
        {"year": 1985, "date": "1985-10-18", "event": "林副科长投湖。账本 27 笔贪污,只 13 笔确认",
         "related_foreshadows": ["1985_linmou_other26"], "tags": ["林某", "13"]},
        {"year": 1986, "date": "1986-08-17", "event": "钱塘江归航沉船。卖出 8 票,死 7 工人。1 顶『林』字硬币",
         "related_foreshadows": ["1986_lin_coin", "1986_no_eighth"], "tags": ["7 工人", "替死鬼"]},
        {"year": 1987, "event": "柳浪闻莺 308 阶,红衣 13 号替死鬼最后一次出现",
         "related_foreshadows": ["1987_red_dress_truth"], "tags": ["13", "替死鬼"]},
        {"year": 1991, "date": "1991-04-23", "event": "留下小学 203 琴房,叶某自缢。同桌『赵某』缺席",
         "related_foreshadows": ["1991_yeh_classmate", "1991_grandma_link"],
         "tags": ["叶某", "留下小学", "11 岁的你"]},
        {"year": 1996, "date": "1996-08-23", "event": "万象城 B3 货梯,何小燕(9 岁)失踪。继父报案",
         "related_foreshadows": ["1996_red_girl_truth"], "tags": ["红衣女孩", "货梯"]},
        {"year": 2007, "event": "孔雀大厦塌一层。地基挖出乌龙王石像,被砸",
         "related_foreshadows": [], "tags": ["孔雀大厦", "乌龙王"]},
        {"year": 2009, "event": "浙大钟楼 99 数事件。SLH 论坛热帖",
         "related_foreshadows": [], "tags": ["浙大钟楼"]},
        {"year": 2013, "event": "12 任 G-273 中最后一任『数据化』,留在对讲机频段",
         "related_foreshadows": ["G272_predecessor_identity"], "tags": ["G-273", "对讲机"]},
        {"year": 2024, "event": "你(赵某)入职。第 13 任 G-273",
         "related_foreshadows": ["8_self_roster"], "tags": ["G-273", "13", "主角"]},
    ],
}
