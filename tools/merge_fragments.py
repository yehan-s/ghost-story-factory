...
STORY_META = {
    ...
    "characters": {
        ...
        "linmou_1985": {
            "label": "林副科长 · 1985-10-18 投湖前夜(前传 1/3)",
            "start_node": "n_l1985_entry",
            "initial_inv": ["蓝布人造革账册包", "26 联签拨款单复印件", "搪瓷缸"],
            "initial_flags": {},
            "initial_known_landmarks": ["L1", "L2", "L3", "L4"],
        ...
        # "redgirl_1996": {"label": "林晓燕 · 万象城货梯 1996-08-23", ...},
    ...
    #                  S2(柳浪) ── S3(九溪)
    "landmark_map": [
        {"id": "S1", "node_id": "n_s1_arrive", "character": "G-273", "time": "20:27",
         "place": "湖滨第三把绿色长椅", "short": "湖滨", "unlock": None,
         "connections": ["S4", "S5", "S7"]},
        {"id": "S2", "node_id": "n_s2_arrive", "character": "G-273", "time": "21:47",
         "place": "柳浪闻莺 307 阶", "short": "柳浪", "unlock": None,
         "connections": ["S3", "S4"]},
        {"id": "S3", "node_id": "n_s3_arrive", "character": "G-273", "time": "22:48",
         "place": "九溪理安寺裂钟", "short": "九溪", "unlock": None,
         "connections": ["S2"]},
        {"id": "S4", "node_id": "n_s4_arrive", "character": "G-273", "time": "00:11",
         "place": "中山中路羊血弄 2 号", "short": "羊血", "unlock": None,
         "connections": ["S1", "S2"]},
        {"id": "S5", "node_id": "n_s5_arrive", "character": "G-273", "time": "01:08",
         "place": "留下小学 203 琴房", "short": "留下", "unlock": None,
         "connections": ["S1", "S6"]},
        {"id": "S6", "node_id": "n_s6_arrive", "character": "G-273", "time": "01:52",
         "place": "联庄站 B4 盾构井", "short": "联庄",
         "unlock": {"shifts_completed_min": 3},
         "unlock_hint": "夜班 ≥3 班",
         "connections": ["S5"]},
        {"id": "S7", "node_id": "n_s7_arrive", "character": "G-273", "time": "04:17",
         "place": "平海街 1 号 · B3 货梯井", "short": "平海",
         "unlock": {"shifts_completed_min": 5},
         "unlock_hint": "夜班 ≥5 班(终局)",
         "connections": ["S1"]},
        {"id": "L1", "node_id": "n_l1985_abacus_01", "character": "linmou_1985",
         "time": "17:30",
         "place": "二轻物资财务科 · 算盘房", "short": "算盘房",
         "unlock": None,
         "connections": ["L2", "L3", "L4"]},
        {"id": "L2", "node_id": "n_l1985_boiler_01", "character": "linmou_1985",
         "time": "18:30",
         "place": "二轻物资财务科 · 锅炉房后院", "short": "锅炉房",
         "unlock": None,
         "connections": ["L1", "L3"]},
        {"id": "L3", "node_id": "n_l1985_archive_01", "character": "linmou_1985",
         "time": "19:30",
         "place": "二轻物资财务科 · 档案室(地下半层)", "short": "档案室",
         "unlock": None,
         "connections": ["L1", "L2", "L4"]},
        {"id": "L4", "node_id": "n_l1985_pavilion_01", "character": "linmou_1985",
         "time": "21:00",
         "place": "西湖锦带桥东侧凉亭", "short": "凉亭",
         "unlock": None,
         "connections": ["L1", "L3"]},
    ],
    ...
    "npcs": {
        ...
        "redgirl_1996": {
            "label": "红衣女孩 · 林晓燕",
            "real_name": "林晓燕(11 岁,林志诚遗腹女,1996-08-23 货梯事故)",
            "death_year": 1996,
            "initial_location": "S2",
            "related_foreshadows": ["1996_red_girl_truth"],
            "key_items": ["14 寸黑白电视", "27 楼通道钥匙", "红衣女孩铜锈", "1991 班级合照"],
            "dialog_topics": ["万象城货梯", "父亲林志诚", "叶某的白布鞋", "1987 红衣 13 号"],
            "relations": {
                "linmou_coat": "父亲(1985 投湖后成为 G-273 候补)",
                "lake_red_dress_13": "前任替死鬼(1987 → 1996 编号承袭)",
                "yeh_1991": "同岁未结女孩(共用白布鞋污染)",
            },
    ...
    "foreshadows": {
        ...
        "1996_red_girl_truth": {
            ...
            "year": 1996,
            "theme": "数据化",
            "summary_locked": "她抱着 14 寸黑白电视,屏幕里是她自己。1996-08-23,万象城货梯,有个孩子失踪,姓名被档案刮掉。",
            "summary_resolved": "她叫林晓燕,11 岁,林志诚遗腹女。1996 年货梯事故里,杭州常数把她作为 G-273 候补数据化保留。",
            "explained_by_character": "red_girl_1996",
            "explained_by_ending": "E_TRUTH",
            "shards": [
                {"id": "tv_screen", "label": "14 寸电视屏",
                 "text": "电视屏里**是她自己** —— 1996 年万象城货梯,她听见有人叫『晓燕』,门外却只有雪花声。"},
                {"id": "missing_report", "label": "1996-08-23 失踪通报",
                 "text": "档案室 1996 年报案记录:**林晓燕**, 11 岁,父亲栏被刮掉;刮痕底下能看见『**林志诚**』三个字。"},
    ...
    "timeline": [
        ...
        {"year": 1991, "date": "1991-04-23", "event": "留下小学 203 琴房,叶某自缢。同桌『赵某』缺席",
         ...
         "tags": ["叶某", "留下小学", "11 岁的你"]},
        {"year": 1996, "date": "1996-08-23", "event": "万象城 B3 货梯,林晓燕(11 岁)事故失踪。父亲栏被刮除",
         "related_foreshadows": ["1996_red_girl_truth"],
